		...
		switch (ret)
		{
			...
			case 8:
				...
				switch(GCSettings.sfxOverclock)
				{
					...
					case 1: Settings.SuperFXSpeedPerLine = 0.417 * 20.5e6; reset_sfx = true; break;
					case 2: Settings.SuperFXSpeedPerLine = 0.417 * 40.5e6; reset_sfx = true; break;
					case 3: Settings.SuperFXSpeedPerLine = 0.417 * 60.5e6; reset_sfx = true; break;
				}
